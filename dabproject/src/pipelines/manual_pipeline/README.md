...
This folder defines all source code for the 'manual_pipeline' pipeline:
...
* Take a look at the sample under "sample_users_manual_pipeline.py" to get familiar with the syntax.
